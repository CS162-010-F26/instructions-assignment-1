...
1.  The Canvas page for this assignment provides a link to accept the
    ...
    few minutes. It will generate
    a GitHub repository for you
    containing the starter code for this assignment.

2.  You should have been redirected to the main page of your
...
3.  Select the “SSH” tab in the small popup window (it might already be
    selected).

    ![github clone](res/ssh-tab.png)

4.  Click the copy icon to the right of the SSH URL to copy the
...
5.  In your terminal connected to the ENGR servers, type `cd` and press
...
6.  Run the following shell command:
...
7.  Running the above command should have downloaded a copy of (i.e.,
...
8.  Navigate into your cloned assignment directory using `cd`.

9. Type `git status` and press enter. This command can be executed from
